...
class Game:
	def __init__(self):
		...
		pygame.display.set_caption('Scape Mission')
		...
		# scale factor
		bg_height = pygame.image.load('../graphics/environment/background1.png').get_height()
	...
	def collisions(self):
		...
		or self.plane.rect.top <= 0:
			...
			choco = pygame.mixer.Sound('../sounds/c.wav')
			choco.set_volume(1)
			choco.play()
			self.active = False
			self.plane.kill()
